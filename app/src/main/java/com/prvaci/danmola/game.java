...
public class game extends AppCompatActivity {
    ...
    String[][] pitanja = {{"Koji od navedenih iskaza je tačan? Vodonik:","","gradi jednoatomske molekule","je teži od vazduha","je gas","je bele boje","3"},
            ...
            {"Koji se od sledecih nemetala nalazi u istoj grupi Periodnog sistema elemenata sa sumporom:","","azot","kiseonik","hlor","ugljenik","2"},
            ...
            {"Izdvoj tačno tvrđenje:","","grafit i dijamant su jedinjenja ugljenika","ugljenik(IV)-oksid je lakši od vazduha","kristalna rešetka dijamanta sačinjena je od molekula ","potpunim sagorevanjem ugljenika nastaje ukljen(II)-oksid","1"},
            {"Reakcijom CO₂+H₂O dobija se:","","HCO₃","H₂CO₃","CH₃OH","HCHO","2"},
            ...
            {"Koji iskaz je tačan? Srebro je:","","dobar provodnik","crvene boje","mekano i može se seći nožem","tečnog agregatnog stanja pri normalnim uslovima","1"},
            ...
            {"Metal koji ima magnetna svojstva je:","","bakar","srebro","gvoždje","aluminijum","3"},
